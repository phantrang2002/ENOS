...
import static com.example.enos.ViewStoryActivity.FILE_TYPE;
import static com.example.enos.ViewStoryActivity.VIDEO_URL_KEY;
...
import com.example.enos.StoryAddActivity;
import com.example.enos.ViewStoryActivity;
...
public class StoriesAdapter extends RecyclerView.Adapter<StoriesAdapter.StoriesHolder> {
    ...
    public void onBindViewHolder(@NonNull StoriesHolder holder, @SuppressLint("RecyclerView") int position) {
        StoriesModel currentStory = list.get(position);
        if (position == 0) {
            ...
            holder.nameTv.setText(currentStory.getName()); // Hiển thị tên người đăng story
