...
public class ChatUserAdapter extends RecyclerView.Adapter<ChatUserAdapter.ChatUserHolder> {
   ...
   // List<ChatUserModel> list;
    private final List<ChatUserModel> list;
    private List<ChatUserModel> filteredList; // For search functionality
    ...
    public void updateList(List<ChatUserModel> newList) {
        list.clear();
        if (newList != null) {
            list.addAll(newList);
        }
